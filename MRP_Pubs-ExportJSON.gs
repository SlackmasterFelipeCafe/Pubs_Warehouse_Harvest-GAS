...
function getRowsData_(sheet, options) {
  var headersRange = sheet.getRange(2, 1, sheet.getFrozenRows(), sheet.getMaxColumns());// change this to row 2 for our data - has harvest info in first row original code: var headersRange = sheet.getRange(1, 1, sheet.getFrozenRows(), sheet.getMaxColumns());
